...
//        textView.setText(getString(R.string.ttid) + "." + new DuplicateClazz().dup() + "_tpatch");
        ...
        try {
            ACCSClient.getAccsClient(AccsClientConfig.DEFAULT_CONFIGTAG).registerDataListener("accs", new AccsAbstractDataListener() {
                @Override
        ...
        haBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                //Toast.makeText(WelcomActivity.this, "待接入", Toast.LENGTH_SHORT).show();
        ...
        dexPatchBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Toast.makeText(WelcomActivity.this, "待接入", Toast.LENGTH_SHORT).show();
//                ACCSManager.AccsRequest request = new ACCSManager.AccsRequest("111", "demo_service", "我是ss data/ack".getBytes(), null);
//                try {
//                    ACCSClient.getAccsClient(AccsClientConfig.DEFAULT_CONFIGTAG).sendData(request);
//                } catch (AccsException e) {
//                    e.printStackTrace();
//                }
            }
        ...
        weexBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
//                ACCSManager.AccsRequest request = new ACCSManager.AccsRequest("111", "demo_service", "我是ss request/response".getBytes(), null);
//                try {
//                    ACCSClient.getAccsClient(AccsClientConfig.DEFAULT_CONFIGTAG).sendRequest(request);
//                } catch (AccsException e) {
//                    e.printStackTrace();
//                }
               Intent intent = new Intent();
               ...
               startActivity(intent);
                Toast.makeText(WelcomActivity.this, "这是Patch包66", Toast.LENGTH_SHORT).show();
            }
        });
